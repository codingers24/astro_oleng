  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pelanggan/data_pelanggan.php">Data Pelanggan</a>
        </li>
        <li class="nav-item">
            ...
            <tbody>
              ...
              if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  echo "<td>";
                  echo "<a href='edit_pelanggan.php?id_pelanggan=" . $row['id_pelanggan'] . "' class='btn btn-primary'>Edit</a>";
                  echo "<a href='hapus_pelanggan.php?id_pelanggan=" . $row['id_pelanggan'] . "' class='btn btn-danger'>Hapus</a>";
                  echo "</td>";
                  echo "</tr>";
                }
              } else {
